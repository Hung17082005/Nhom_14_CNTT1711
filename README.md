...
### Luồng nghiệp vụ:
**1. Dữ liệu thô:** Chấm công, phiếu lương và đơn từ được khởi tạo trên Odoo.
**2. Xử lý:** Dashboard kéo dữ liệu về, AI thực hiện phân tích lịch sử vi phạm, quy luật vi phạm của nhân sự.
**3. Phê duyệt:** Quản lý xem nhận xét của AI và duyệt đơn ngay trên Dashboard.
**4. Quyết toán:** Dữ liệu sau duyệt được đẩy sang bảng Lương để tính toán Thực lĩnh.
**5. Hoàn tất:** Gửi Email thông báo lương hoặc tình trạng duyệt đơn cho toàn bộ nhân viên.
